...
public class ApplicationService {
    ...
    public ApplicationResponseDTO updateStatus(UUID applicationId, StatusUpdateRequestDTO request) {
        ...
        if (currentUser.getCompany() == null
            ...
            throw new AccessDeniedException("Unauthorized: You do not have permission to manage this application");
        }
    ...
    public List<ApplicationResponseDTO> getApplicationsForJob(UUID jobId) {
        ...
        if (currentUser.getCompany() == null || !currentUser.getCompany().getId().equals(job.getCompany().getId())) {
            throw new AccessDeniedException("Unauthorized: You do not have permission to view these applications");
        }
